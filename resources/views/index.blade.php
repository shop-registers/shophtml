...
@section('user')
    @if(!empty($user))
        <span>欢迎,{{$user['name']}}登录,<a href="">退出</a></span>
    @else
            ...
            <div class="banner">
                      <!--轮播 -->
                        <div class="am-slider am-slider-default scoll" data-am-flexslider id="demo-slider-0">
                            <ul class="am-slides">
                                <li class="banner1"><a href="introduction.html"><img src="{{$img[0]}}" /></a></li>
                                <li class="banner2"><a><img src="{{$img[1]}}" /></a></li>
                                <li class="banner3"><a><img src="{{$img[2]}}" /></a></li>
                                <li class="banner4"><a><img src="{{$img[3]}}" /></a></li>
                ...
                <div class="slideall">
                       ...
                       <div class="nav-cont">
                            <ul>
                                ...
                                <li class="qc"><a href="#">团购</a></l</a></li>
                            </ul>
                            <div class="nav-extra">
                                            ...
                                            @foreach($data as $item)
                                                <li class="appliance js_toggle relative">
                                                    <div class="category-info">
                                                        <h3 class="category-name b-category-name"><i><img src="static/images/cake.png"></i><a class="ml-22" title="点心">{{$item['type_name']}}</a></h3>
                                                        <em>&gt;</em></div>
                ...
                <div class="shopMain" id="shopmain">
                      ...
                      <div class="am-g am-g-fixed ">
                        <div class="am-u-sm-3 ">
                            ...
                            <div class="activityMain ">
                                <a href="#"><img src="static/images/activity1.jpg "></img></a>
                            </div>
                            ...
                            /*$(document).ready(function(){
                                ...
                                function tim(){
                                    ...
                                    if(difftime > 0){
                                        ...
                                        var secends = Math.floor(difftime%60);
                                        $('#info h3').html(hours + ':' + minutes + ':' + secends);
                                    }else{
                                        alert('活动结束');
                                    }
                    ...
                    <div class="am-container ">
                        <div class="shopTitle ">
                            ...
                            <span class="more ">
                    <a href="spike/1">更多美味<i class="am-icon-angle-right" style="padding-left:10px ;" ></i></a>
                        </span>
                        </div>
                    </div>
